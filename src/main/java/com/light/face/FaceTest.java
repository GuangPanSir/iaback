...
public class FaceTest {
	...
	public static void main ( String[] args ) {
		...
		//从官网获取
		String appId = "21J5VxXnYJ6fv6WoTXv5KxkeSrPT65sYC8VEY82fo4Zp";
		String sdkKey = "EYXSr2oJinQbe42GGSYMezMjNiS4LrZyyQ41ngm9LA54";
		
		
		FaceEngine faceEngine = new FaceEngine ( "E:\\Chorme\\ArcSoft_ArcFace_Java_Windows_x64_V3.0\\libs\\WIN64" );
		//激活引擎
		...
		System.out.println ( "潘光健02特征值大小：" + faceFeature2.getFeatureData ( ).length );
...
/*
		...
		System.out.println ( "潘光健03IR活体：" + irLivenessInfo.get ( 0 ).getLiveness ( ) );
